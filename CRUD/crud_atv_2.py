...
def encontrar_por_email(lista_clientes, email_buscar):
...
def atualizar_clientes(lista_clientes):
    ...
    cliente_para_atualizar = encontrar_por_email(lista_clientes, email_buscar)
...
def excluir_cliente(lista_clientes):
    ...
    cliente_para_remover = encontrar_por_email(lista_clientes, email_buscar)
